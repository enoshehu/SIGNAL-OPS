...
class CliTests(unittest.TestCase):
    def test_dry_run_makes_no_request_and_writes_nothing(self) -> None:
        ...
        with (
            ...
            patch.dict("os.environ", {"SIGNALOPS_DATA_DIR": directory}, clear=False),
    ...
    def test_db_dry_run_does_not_print_credentials(self) -> None:
        ...
        self.assertIn("/plan/8000098/260914/12", output.getvalue())
    ...
    def test_disabled_source_cannot_run(self) -> None:
        ...
        output = StringIO()
        with patch("signalops.cli.load_settings", return_value=disabled), redirect_stdout(output):
            result = main(
                [
                    "ingest",
                    "--source",
